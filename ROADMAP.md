...
> 清单第 10 项（vanguards）：客户端 HS 固定 L2 并落盘（#65），**仍 PARTIAL**（无 L3、无托管侧、无共识 `guard-hs-l2-*`）。第 7 项洋葱托管 INTRODUCE2 是观察/超大项，不要空 PR。第 11 项 Bridge/PT 只改文档。下一项代码缺口：第 4 项 HSDir / INTRODUCE1 / RENDEZVOUS1。
