...
type Metrics struct {
	...
	BackpressurePauses     *Counter   // Number of times stream backpressure was applied
	BackpressureResumes    *Counter   // Number of times stream backpressure was released
