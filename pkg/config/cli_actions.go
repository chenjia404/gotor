...
func DumpConfig(cfg *Config, mode string) string {
	...
	all := []pair{
		...
		{"DoSCircuitCreationEnabled", FormatDoSEnabled(cfg.DoSCircuitCreationEnabled)},
		{"DoSCircuitCreationMinConnections", fmt.Sprintf("%d", cfg.DoSCircuitCreationMinConnections)},
		{"DoSCircuitCreationRate", fmt.Sprintf("%d", cfg.DoSCircuitCreationRate)},
		{"DoSCircuitCreationBurst", fmt.Sprintf("%d", cfg.DoSCircuitCreationBurst)},
		{"DoSCircuitCreationDefenseTimePeriod", formatDuration(cfg.DoSCircuitCreationDefenseTime)},
		{"DoSCircuitCreationDefenseType", fmt.Sprintf("%d", cfg.DoSCircuitCreationDefenseType)},
		{"DoSConnectionEnabled", FormatDoSEnabled(cfg.DoSConnectionEnabled)},
		{"DoSConnectionMaxConcurrentCount", fmt.Sprintf("%d", cfg.DoSConnectionMaxConcurrentCount)},
	...
	defMap := map[string]string{
		...
		"DoSCircuitCreationEnabled":             FormatDoSEnabled(defaults.DoSCircuitCreationEnabled),
		"DoSCircuitCreationMinConnections":      fmt.Sprintf("%d", defaults.DoSCircuitCreationMinConnections),
		"DoSCircuitCreationRate":                fmt.Sprintf("%d", defaults.DoSCircuitCreationRate),
		"DoSCircuitCreationBurst":               fmt.Sprintf("%d", defaults.DoSCircuitCreationBurst),
		"DoSCircuitCreationDefenseTimePeriod":   formatDuration(defaults.DoSCircuitCreationDefenseTime),
		"DoSCircuitCreationDefenseType":         fmt.Sprintf("%d", defaults.DoSCircuitCreationDefenseType),
		"DoSConnectionEnabled":                  FormatDoSEnabled(defaults.DoSConnectionEnabled),
		"DoSConnectionMaxConcurrentCount":       fmt.Sprintf("%d", defaults.DoSConnectionMaxConcurrentCount),
