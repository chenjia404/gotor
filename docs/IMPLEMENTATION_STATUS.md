...
- **中继（#59）**：可识别 ntor-v3 type 3 `[02 06]` 并 ENC_UIV 剥层/回程；出口电路级 SENDME v1（16 字节 CGO tag FIFO）；**未**宣告 `Relay=5-6`；无真网被请求证据。见 `docs/interop/cgo-relay.md`。
...
- **缺口**：官方 v0 relay-cell 向量；中继侧 Vegas / 真网被请求 CGO。
