...
- [ ] **状态**：PARTIAL（官方 `DoS*` 键 + CREATE2/每 IP + **auto 跟共识** + **ConnectRate/Burst** + **StreamCreation** + **AUTHENTICATE 单跳区分**）
...
- **要做**：`DoSCircuitCreationDefenseType` 除拒绝以外的类型。
