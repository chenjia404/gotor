...
- [ ] **状态**：PARTIAL（官方 `DoS*` 键 + CREATE2/每 IP + **auto 跟共识** + **ConnectRate/Burst**；**无** StreamCreation）
...
- **要做**：`DoSStreamCreation*`；按 AUTHENTICATE 区分中继单跳。
