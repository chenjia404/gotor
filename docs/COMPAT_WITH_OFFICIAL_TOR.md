...
- [ ] **状态**：PARTIAL（digest 交叉引用 + 观测带宽历史已接线，含出站中间跳 OR；**conn-bi-direct / ipv6-conn-bi-direct 满 24h 才写**；**无** dirreq/exit/hidserv，**无**真网权威归档观察）
...
- **要做**：dirreq / exit / hidserv（需 24h 观测）；真网权威归档。不要把空统计当完整。
